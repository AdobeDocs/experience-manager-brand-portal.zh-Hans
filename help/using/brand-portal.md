...
请参阅Brand Portal中的[资源源](brand-portal-asset-sourcing.md)。
...
> * [Assets Prime](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/assets-prime) 或 [Assets Ultimate](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/assets-ultimate-overview) 不提供 Brand Portal。 但是，已经有权访问Assets as a Cloud Service的现有Brand Portal客户在迁移到Assets Ultimate时可以继续使用它。
...
但是，Experience Manager Assets（内部部署版和Managed Services版）是使用Brand Portal手动配置的，Adobe Developer Console可获取Adobe Identity Management Services (IMS)令牌以授权Brand Portal租户。
...
但是，来宾会话会限制您创建收藏集和保存的搜索。 来宾会话中的用户无法访问文件夹和收藏集设置，也无法以链接形式共享资产。 以下是访客用户可以执行的任务列表：
...
* [将文件夹发布到Brand Portal](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-65/content/assets/brandportal/brand-portal-publish-folder)
* [将收藏集发布到Brand Portal](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-65/content/assets/brandportal/brand-portal-publish-collection)
...
1. 从Brand Portal登录页面中，选择与&#x200B;**[!UICONTROL 需要访问？]**&#x200B;对应的&#x200B;**[!UICONTROL 单击此处]**。 但是，要进入来宾会话，请选择与&#x200B;**[!UICONTROL 来宾访问？]**&#x200B;对应的&#x200B;**[!UICONTROL 单击此处]**。
...
1. 在[!UICONTROL Experience Cloud设置]页面上，从[!UICONTROL 语言]下拉菜单中选择语言。
