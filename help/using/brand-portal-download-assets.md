...
>
>如果您不想使用® Aspera Connect并继续正常下载过程，请联系Brand Portal管理员以关闭&#x200B;**[!UICONTROL 快速下载]**&#x200B;设置。
...
* **[!UICONTROL 快速下载]**
  ...
  它提供了使用® Aspera Connect加速资源下载的功能。 默认情况下，**[!UICONTROL 下载设置]**&#x200B;中的&#x200B;**[!UICONTROL 快速下载]**&#x200B;设置已启用。
...
以管理员身份登录您的 Brand Portal 租户并导航至&#x200B;**[!UICONTROL 工具]** > **[!UICONTROL 下载]**。
...
以管理员身份登录您的 Brand Portal 租户并导航至&#x200B;**[!UICONTROL 工具]** > **[!UICONTROL 用户]**。 在&#x200B;**[!UICONTROL 用户角色]**&#x200B;页面中导航到&#x200B;**[!UICONTROL 组]**&#x200B;选项卡，配置用户组的查看和（或）下载设置。
...
1. 登录到您的Brand Portal租户。 默认情况下，**[!UICONTROL 文件]**&#x200B;视图打开，其中包含所有已发布的资源和文件夹。
   ...
   * 要下载资源的特定资源演绎版，请将指针悬停在资源上，然后单击快速操作缩略图中显示的&#x200B;**[!UICONTROL 下载]**&#x200B;图标。
     ...
     >[!NOTE]
     >
     >如果您是首次下载资源，并且浏览器中未安装® Aspera Connect，则会提示您安装Aspera下载加速器(`https://www.ibm.com/docs/en/aspera-connect/3.9.9`)。
...
1. 默认情况下，**[!UICONTROL 下载设置]**&#x200B;中启用了&#x200B;**[!UICONTROL 快速下载]**&#x200B;设置。 因此，会显示一个确认框，以允许使用® Aspera Connect加速下载。

   若要继续使用&#x200B;**[!UICONTROL 快速下载]**，请单击&#x200B;**[!UICONTROL 允许]**。 使用® Aspera Connect将所有选定的呈现版本下载到zip文件夹中。
