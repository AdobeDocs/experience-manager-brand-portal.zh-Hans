...
Brand Portal搜索功能允许您使用搜索功能快速搜索相关资产，并使用筛选器进行Facet搜索以帮助您进一步缩小搜索范围。 您还可以将搜索保存为智能收藏集，以供将来使用。
...
1. 在“编 **[!UICONTROL 辑智能收藏集]**”对话框中，选择**[!UICONTROL &#x200B;另存为]** ，然后输入智能收藏集的名称。 单击&#x200B;**[!UICONTROL 保存]**。
