...
通过“路径”列，您可以轻松地识别文件夹层次结构中的资产位置。 您可以通过点按/单击资源名称对层次结构进行向下导航，然后使用标题](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/essentials/basic-handling.html)中的[痕迹导航再次向上导航。
