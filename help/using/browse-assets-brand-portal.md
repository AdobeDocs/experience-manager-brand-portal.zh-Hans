...
您可以通过点按／单击卡（注意避免快速操作）在层次结构中向下导航，也可以使用标题](https://helpx.adobe.com/experience-manager/6-5/sites/authoring/using/basic-handling.html#TheHeader)中的[痕迹导航再次向上导航。
...
在选择资产／文件夹时选择&#x200B;**[!UICONTROL 概述]**&#x200B;选项，用户可以查看资产创建的标题、路径和时间。 但是，在资产详细信息页面上，选择概述选项可让用户查看资产的元数据。
...
**[!UICONTROL 视图]** 设置对话框在从视图选择 **[!UICONTROL 器]** 中选择视图设置时打开。它允许您在卡片视图中调整资产缩略图大小。 这样，您就可以个性化视图并控制显示的缩略图数量。
...
通过“路径”列，您可以轻松地在文件夹层次结构中标识资产位置。 您可以通过点按／单击资源名称向下导航层次结构，然后使用标题](https://helpx.adobe.com/experience-manager/6-5/sites/authoring/using/basic-handling.html#TheHeader)中的[痕迹导航向上导航。
...
列表视图默认将资产&#x200B;**[!UICONTROL 名称]**&#x200B;显示为第一列。 还显示资产&#x200B;**[!UICONTROL 标题]**、**[!UICONTROL 区域设置]**、**[!UICONTROL 类型]**、**[!UICONTROL Dimension]**、**[!UICONTROL 大小]**、**[!UICONTROL 评级]**&#x200B;等其他信息，发布状态。 但是，可以使用&#x200B;**[!UICONTROL 视图设置]**&#x200B;选择要显示的列。
...
要打开树视图，请点按／单击左上角的边栏选择器，并从菜单中选择&#x200B;**[!UICONTROL 内容树]**。
...
要打开资产属性页面，请使用顶栏中的&#x200B;**[!UICONTROL 属性(p)]**&#x200B;选项。
