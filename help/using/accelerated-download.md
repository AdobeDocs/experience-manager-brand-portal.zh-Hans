...
Adobe Experience Manager Assets Brand Portal与IBM® Aspera Connect集成，这是一款按需安装的应用程序，可增强大型资产文件的下载性能。 该应用程序使用专有技术来删除TCP开销，并帮助提高资产文件的传输速度。 此集成可确保增强的下载体验。
...
下表显示使用Aspera Connect文件下载加速器下载2 GB文件的性能：
...
1. 默认情况下， **[!UICONTROL 快速下载]** 设置 **[!UICONTROL 下载设置]**. 因此，系统会显示一个确认框，用于使用IBM® Aspera Connect下载资产。
   ...
   如果您是首次下载资产，并且浏览器中未安装IBM® Aspera Connect，或者现有版本已过期，系统会提示您安装Aspera下载加速器(`https://www.ibm.com/docs/en/aspera-connect/3.9.9`)。
...
要在Microsoft® Edge上使用加速下载功能，请将Brand Portal网站从受信任的网站列表中删除。
...
1. 检查端口是否未被阻止。 使用Google搜索功能可根据所使用的操作系统查找用于检查端口是否被阻止的选项。  <!-- THIS URL IS 404 AND DOES NOT REDIRECT [https://test-connect.asperasoft.com](https://test-connect.asperasoft.com/) from your computer. -->
