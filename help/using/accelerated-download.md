...
* 使用管理员权限（[® Aspera Connect下载](https://www.ibm.com/support/fixcentral/swg/selectFixes?parent=ibm%7EOther%20software&product=ibm/Other+software/IBM+Aspera+Connect&release=3.9.9&platform=All&function=all)）在浏览器的扩展中安装IBM® Aspera Connect 3.9.9 **。**

>[!NOTE]
>
>® Aspera Connect存在已知问题。 快速下载不适用于® Aspera Connect版本3.10及更高版本。
...
1. 默认情况下，**[!UICONTROL 下载设置]**&#x200B;中启用了&#x200B;**[!UICONTROL 快速下载]**&#x200B;设置。 因此，会显示一个确认框，用于使用® Aspera Connect下载资源。

   如果您是首次下载资源，并且浏览器中未安装® Aspera Connect，则会提示您安装它。 如果现有版本已过期，系统还会提示您安装[Aspera下载加速器](https://www.ibm.com/support/fixcentral/swg/selectFixes?parent=ibm%7EOther%20software&product=ibm/Other+software/IBM+Aspera+Connect&release=3.9.9&platform=All&function=all)。

   ![](assets/aspera-not-launched.png)

1. **安装Aspera Connect客户端**

   要安装® Aspera Connect客户端安装程序，请从IBM® Aspera Connect客户端应用程序的.msi文件运行安装程序，然后按照安装向导进行操作。

   ![](assets/aspera-download-1.png)

1. 成功安装客户端后，请刷新浏览器页面并再次启动下载步骤。

1. 若要继续使用&#x200B;**[!UICONTROL 快速下载]**，请单击&#x200B;**[!UICONTROL 允许]**。 使用® Aspera Connect将所有选定的呈现版本下载到zip文件夹中。

   成功完成下载后，将会显示一个对话框，其中显示了将资产下载到用户系统的位置。

   ![](assets/aspera-download-2.png)

   如果您不想使用® Aspera Connect，请单击&#x200B;**[!UICONTROL 拒绝]**。 如果&#x200B;**[!UICONTROL 快速下载]**&#x200B;被拒绝或失败，则系统填充错误消息。 单击&#x200B;**[!UICONTROL 正常下载]**&#x200B;按钮继续下载资产。

>[!NOTE]
>
>如果管理员关闭了&#x200B;**[!UICONTROL 快速下载]**&#x200B;设置，则所选格式副本将直接下载到zip文件夹中，而无需使用® Aspera Connect。
...
## 在® Edge浏览器上使用文件加速器 {#using-file-accelerator-on-microsoft-edge-browser}

® Edge在增强保护模式(EPM)下运行，以防止在同一个专用网络或受信任站点上与Aspera Connect服务器通信。 因此，每次建立与服务器的连接时都会出现一个弹出窗口。

![](assets/switchapps-msedge.png)

要在® Edge上使用加速下载功能，请从“受信任的站点”列表中删除Brand Portal站点。
...
在® Aspera Connect客户端首选项中，可通过右键单击图标并选择&#x200B;**[!UICONTROL 首选项]**&#x200B;来设置一些有用的首选项。
