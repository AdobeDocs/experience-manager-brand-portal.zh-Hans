...
>[!NOTE]
>
>IBM Aspera Connect存在一个已知问题。 快速下载不适用于IBM Aspera Connect版本3.10及更高版本。
...
| 客户端位置 | 客户端和服务器之间的延迟（毫秒） | Aspera Connect File Transfer Accelerator (MBps)的速度 | 使用Aspera File Transfer Accelerator下载2 GB文件所需的时间（秒） |
|---------------------------|-----------------------------------|---------------------------------------------|-------------------------------------------------------------------------|
...
在IBM Aspera Connect客户端首选项中，可通过右键单击图标并选择 **[!UICONTROL 首选项]**.
...
如果下载加速功能不适合您，请按照以下步骤进行故障排除：

1. 通过访问，检查端口是否未被阻止 [https://test-connect.asperasoft.com](https://test-connect.asperasoft.com/) 从你的电脑里。
