...
Brand Portal用户可以[下载资产要求](brand-portal-download-asset-requirements.md)来了解贡献的需要。
...
>
>任何Brand Portal租户的最大上传限制为&#x200B;**10** GB（累计应用于所有贡献文件夹）。
...
>
>如果需要将您的Brand Portal租户的上传限制扩展至&#x200B;**10** GB以外，请与Adobe支持联系，以指定要求。
...
1. 单击&#x200B;**[!UICONTROL 创建]** > **[!UICONTROL 文件]**&#x200B;以上传包含多个资产的单个文件或文件夹(.zip)。
