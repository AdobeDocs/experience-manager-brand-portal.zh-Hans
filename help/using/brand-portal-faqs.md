---
title: 常见问题解答
description: 洞察 Adobe Experience Manager Assets Brand Portal 中的常见问题。
...
**问题：在升级到 Adobe Developer Console 后，我无法将 Brand Portal 中的贡献文件夹的资产发布到 Experience Manager Assets。 我的创作实例位于Experience Manager Assets 6.5.4。 可能的原因是什么？**
